// Found on http://intrepidis.blogspot.com/2014/02/xbrz-in-java.html
// License: GPLv3
...
//  return distNonLinearRGB(pix1, pix2);
    ...
    private static final class Kernel_3x3 {
        public final int[] __ = new int[3 * 3];
    }
  ...
  */
    ...
    private final void preProcessCorners(final Kernel_4x4 ker) {
        ...
        final int weight = 4;
        final double jg = dist.__(ker.i, ker.f) + dist.__(ker.f, ker.c) + dist.__(ker.n, ker.k) + dist.__(ker.k, ker.h) + weight * dist.__(ker.j, ker.g);
        final double fk = dist.__(ker.e, ker.j) + dist.__(ker.j, ker.o) + dist.__(ker.b, ker.g) + dist.__(ker.g, ker.l) + weight * dist.__(ker.f, ker.k);
    ...
    private enum Rot {
        ...
        public static int[] __ = new int[9 * 4];
        ...
        static {
            ...
            for (int rotDeg = 0; rotDeg < 4; rotDeg++)
                for (int x = 0; x < 9; x++)
                    __[(x << 2) + rotDeg] = rotation[rotDeg][x];
        }
    }
    ...
    private final void scalePixel(
        ...
        //final int a = ker.__[Rot.__[(0 << 2) + rotDeg]];
        final int b = ker.__[Rot.__[(1 << 2) + rotDeg]];
        final int c = ker.__[Rot.__[(2 << 2) + rotDeg]];
        final int d = ker.__[Rot.__[(3 << 2) + rotDeg]];
        final int e = ker.__[Rot.__[(4 << 2) + rotDeg]];
        final int f = ker.__[Rot.__[(5 << 2) + rotDeg]];
        final int g = ker.__[Rot.__[(6 << 2) + rotDeg]];
        final int h = ker.__[Rot.__[(7 << 2) + rotDeg]];
        final int i = ker.__[Rot.__[(8 << 2) + rotDeg]];
        ...
        else if (BlendInfo.getTopR(blend) != BlendType.BLEND_NONE && !eq.__(e, g))
            doLineBlend = false;

        else if (BlendInfo.getBottomL(blend) != BlendType.BLEND_NONE && !eq.__(e, c))
            doLineBlend = false;

            //no full blending for L-shapes; blend corner only (handles "mario mushroom eyes")
        else if (eq.__(g, h) && eq.__(h, i) && eq.__(i, f) && eq.__(f, c) && !eq.__(e, i))
            doLineBlend = false;
        ...
        final int px = dist.__(e, f) <= dist.__(e, h) ? f : h;
        ...
        final double fg = dist.__(f, g);
        final double hc = dist.__(h, c);
    ...
    private final void scaleImage(
        ...
        preProcessCorners_colorDist = new IColorDist() {
            public double __(final int col1, final int col2) {
     ...
     */
        ...
        scalePixel_colorEq = new IColorEq() {
            public boolean __(final int col1, final int col2) {
                return colorDist(col1, col2, cfg.luminanceWeight)
                        < eqColorThres;
            }
        };
...
//  //results while processing the the last pixel!
                ...
                //read sequentially from memory as far as possible
                ker3.__[a] = src[s_m1 + x_m1];
                ker3.__[b] = src[s_m1 + x];
                ker3.__[c] = src[s_m1 + x_p1];

                ker3.__[d] = src[s_0 + x_m1];
                ker3.__[e] = src[s_0 + x];
                ker3.__[f] = src[s_0 + x_p1];

                ker3.__[g] = src[s_p1 + x_m1];
                ker3.__[h] = src[s_p1 + x];
                ker3.__[i] = src[s_p1 + x_p1];
    ...
    private interface IColorEq {
        public boolean __(int col1, int col2);
    }

    private interface IColorDist {
        public double __(int col1, int col2);
    }
